...
```Java
		...
		// some built-in function (for more detail, watch preload/*.scm)
...
* Purely functional. (define the same symbol again will cause error)
* nil for false, others for true, nil expressed as '()
